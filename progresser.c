...
void progresser_joueur1(corp_longeur les_x, corp_longeur les_y, bool *collision_joueur, int *x_avant_pomme, int *y_avant_pomme, conteneur block_x, conteneur block_y)
{
    /**
    ...
    if (*collision_joueur == false)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if ((collision_pave(block_x, block_y, les_x[0], les_y[0] + indicateur_y) == false) || indicateur_y == 0)
                {
...
void progresser_joueur2(corp_longeur les_x, corp_longeur les_y, bool *collision_joueur, int *x_avant_pomme, int *y_avant_pomme, conteneur block_x, conteneur block_y)
{
    /**
     * @brief Calcule la nouvelle position du serpent quand il avance sans intervention du joueur
     * @param les_x Liste des positions en X des segments du serpent
